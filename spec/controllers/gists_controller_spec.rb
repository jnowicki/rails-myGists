...
describe GistsController do
  ...
  let(:valid_attributes) { { "snippet" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved gist as @gist" do
        ...
        post :create, {:gist => { "snippet" => "invalid value" }}, valid_session
        assigns(:gist).should be_a_new(Gist)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested gist" do
        ...
        Gist.any_instance.should_receive(:update).with({ "snippet" => "MyText" })
        put :update, {:id => gist.to_param, :gist => { "snippet" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the gist as @gist" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Gist.any_instance.stub(:save).and_return(false)
        put :update, {:id => gist.to_param, :gist => { "snippet" => "invalid value" }}, valid_session
        assigns(:gist).should eq(gist)
      end
